...
final List<ServiceCat> works = [
  const ServiceCat(id: 1, name: 'Freelancer'),
  const ServiceCat(id: 2, name: 'Food Delivery'),
  const ServiceCat(id: 3, name: 'Parcel Delivery'),

];
final List<ServiceCat> locations = [
  const ServiceCat(id: 1, name: 'Dhaka'),
  const ServiceCat(id: 2, name: 'US'),
  const ServiceCat(id: 3, name: 'UK'),
  const ServiceCat(id: 4, name: 'India'),
];
final List<ServiceCat> vehicles = [
  const ServiceCat(id: 1, name: 'Bike'),
  const ServiceCat(id: 2, name: 'Truck'),
  const ServiceCat(id: 3, name: 'Mini Truck'),
];
final List<ServiceCat> documents = [
  const ServiceCat(id: 1, name: 'National ID'),
  const ServiceCat(id: 2, name: 'Berth Certificate'),
  const ServiceCat(id: 3, name: 'Passport'),
];
final List<ServiceCat> date = [
  const ServiceCat(id: 1, name: '09 February 1998'),
